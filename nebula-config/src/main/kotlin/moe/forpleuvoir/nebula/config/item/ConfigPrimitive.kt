...
fun configString(name: String, defaultValue: String) = config(name, defaultValue, Codec.string(defaultValue))

context(group: ConfigGroup)
fun configChar(name: String, defaultValue: Char) = config(name, defaultValue, Codec.char(defaultValue))
...
context(group: ConfigGroup)
fun configBoolean(name: String, defaultValue: Boolean): ConfigBoolean = group.addConfig(ConfigBoolean(name, defaultValue))
...
context(group: ConfigGroup)
fun configByte(name: String, defaultValue: Byte, minValue: Byte = Byte.MIN_VALUE, maxValue: Byte = Byte.MAX_VALUE) =
    number(name, defaultValue, minValue, maxValue, ConfigSerde.of(Codec.byte(defaultValue, minValue..maxValue)))

context(group: ConfigGroup)
fun configShort(name: String, defaultValue: Short, minValue: Short = Short.MIN_VALUE, maxValue: Short = Short.MAX_VALUE) =
    number(name, defaultValue, minValue, maxValue, ConfigSerde.of(Codec.short(defaultValue, minValue..maxValue)))

context(group: ConfigGroup)
fun configInt(name: String, defaultValue: Int, minValue: Int = Int.MIN_VALUE, maxValue: Int = Int.MAX_VALUE) =
    number(name, defaultValue, minValue, maxValue, ConfigSerde.of(Codec.int(defaultValue, minValue..maxValue)))

context(group: ConfigGroup)
fun configLong(name: String, defaultValue: Long, minValue: Long = Long.MIN_VALUE, maxValue: Long = Long.MAX_VALUE) =
    number(name, defaultValue, minValue, maxValue, ConfigSerde.of(Codec.long(defaultValue, minValue..maxValue)))

context(group: ConfigGroup)
fun configFloat(name: String, defaultValue: Float, minValue: Float = Float.MIN_VALUE, maxValue: Float = Float.MAX_VALUE) =
    number(name, defaultValue, minValue, maxValue, ConfigSerde.of(Codec.float(defaultValue, minValue..maxValue)))

context(group: ConfigGroup)
fun configDouble(name: String, defaultValue: Double, minValue: Double = Double.MIN_VALUE, maxValue: Double = Double.MAX_VALUE) =
